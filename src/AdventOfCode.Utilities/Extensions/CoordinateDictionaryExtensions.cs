...
public static class CoordinateDictionaryExtensions
{
    ...
    public static long MaxX<T>(this IDictionary<Coordinate, T> map) => map.Max(c => c.Key.X);
    public static long MaxY<T>(this IDictionary<Coordinate, T> map) => map.Max(c => c.Key.Y);
    public static long MinX<T>(this IDictionary<Coordinate, T> map) => map.Min(c => c.Key.X);
    public static long MinY<T>(this IDictionary<Coordinate, T> map) => map.Min(c => c.Key.Y);
